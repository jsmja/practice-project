...
const STEPS = ['서비스/결제 수단 선택', '카드 선택/결제'];
    ...
    <div>
        ...
        <>
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center gap-3 rounded-xl border border-border bg-white p-4">
              ...
              <span className="ml-auto text-xs text-muted-foreground">계좌이체 추후 제공 예정</span>
            </div>
          </div>
      ...
      {currentStep === 1 && (
        <div className="rounded-xl border border-border bg-white p-8 text-center">
          ...
          <p className="mb-2 font-semibold">카드 선택 및 결제</p>
          <p className="mb-6 text-sm text-muted-foreground">실제 결제 연동 시 카드사 결제창이 표시됩니다.</p>
