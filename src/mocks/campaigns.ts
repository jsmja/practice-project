...
export const MOCK_CAMPAIGNS: ICampaignDto[] = [
  { no: 1, name: '봄 신메뉴 출시 이벤트', type: '커스텀 캠페인', sendFrequency: '반복', sendRound: 3, totalRounds: 5, sendDate: '2026.03.10 10:00', status: '성공', targetCount: 3200, successCount: 3136, failCount: 64 },
  { no: 2, name: '3월 재방문 고객 할인 쿠폰', type: '웰컴백 캠페인', sendFrequency: '반복', sendRound: 2, totalRounds: 4, sendDate: '2026.03.08 14:30', status: '성공', targetCount: 1850, successCount: 1813, failCount: 37 },
  ...
  { no: 6, name: '구매 감사 메시지', type: '구매 감사', sendFrequency: '1회', sendRound: 1, totalRounds: 1, sendDate: '2026.03.03 16:00', status: '성공', targetCount: 45, successCount: 45, failCount: 0 },
  ...
  { no: 8, name: '재방문 유도 캠페인', type: '웰컴백 캠페인', sendFrequency: '1회', sendRound: 1, totalRounds: 1, sendDate: '2026.03.01 14:00', status: '실패', targetCount: 200, successCount: 0, failCount: 200 },
];
