...
export const MOCK_PAYMENT_HISTORY: IPaymentHistoryDto[] = [
  { no: 1, paymentDate: '2026.03.15 11:20', status: '충전완료', productName: '포인트 충전 (50,000P)', subscriptionType: '-', paymentMethod: '신한카드 1234', amount: 51650, reason: '수수료 1,650원 포함', receiptUrl: '#' },
  ...
  { no: 4, paymentDate: '2026.02.15 14:00', status: '충전완료', productName: '포인트 충전 (30,000P)', subscriptionType: '-', paymentMethod: '신한카드 1234', amount: 30990, reason: '수수료 990원 포함', receiptUrl: '#' },
  ...
  { no: 6, paymentDate: '2026.01.25 16:40', status: '충전완료', productName: '포인트 충전 (100,000P)', subscriptionType: '-', paymentMethod: '신한카드 1234', amount: 103300, reason: '수수료 3,300원 포함', receiptUrl: '#' },
