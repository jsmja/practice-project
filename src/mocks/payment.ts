...
export const MOCK_SERVICE_PRODUCTS: IServiceProductDto[] = [
  ...
  { id: 'chat', name: '유료 채팅상담', status: '미사용', monthlyPrice: 9000, annualPrice: 97200, discountRate: 10, description: '카카오/네이버 채팅상담 무제한 제공' },
];
...
export const MOCK_PAYMENT_HISTORY: IPaymentHistoryDto[] = [
  ...
  { no: 3, paymentDate: '2026.01.20 11:00', status: '결제취소', productName: '유료 채팅상담', subscriptionType: '월간', paymentMethod: '신한카드 1234', amount: 9000, reason: '사용자 취소', receiptUrl: '#' },
